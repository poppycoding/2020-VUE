  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="职位级别" prop="level" width="180">
        </el-table-column>
        ...
        <el-table-column label="创建日期" prop="createAt" width="150">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleBatchDelete() {
      this.$confirm(
        "批量删除: " + this.multiSelectRows.length + " 条职称信息,是否继续?",
        "提示",
        {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
